/*
CUSTOMIZATIONS:
- customizations to use buildStyleClassNamesExtenders (backport of this pr: https://github.com/plone/volto/pull/6259. Quando la mergiano e aggiorniamo volto, questo file si puo rimuovere
*/
